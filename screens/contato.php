            ...
            <div class="row" style="padding-right: 15px;">
                <form method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>">
                    <div class="col" style="margin-top: 16px;">
                        ...
                        <div class="mb-3">
                            <input type="text" class="style_input" id="nome_form" name="nome" placeholder="Nome"
                                autocomplete="off">
                        </div>
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            <input type="tel" class="style_input" id="telefone_form" name="telefone"
                                placeholder="Telefone" autocomplete="off">
                        </div>
                        <div class="mb-3">
