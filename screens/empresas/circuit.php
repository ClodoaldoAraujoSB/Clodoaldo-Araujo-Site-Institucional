        ...
        <div class="modal-content bg-dark">
          <div class="modal-header" style="border: 0px;">
            <div id="div_lateral_titulo">
                <img src="../logos/logo-circuit.png" alt="Logo Super Business" style="height: 30px;">
            </div>
          ...
          <div class="modal-footer" id="btn-empresa">
            <a href="https://circuitlaunch.com/" target="_blank" rel="noopener noreferrer"><button type="button" class="btn btn-light text-dark">Saiba Mais</button></a>
          </div>
        </div>
      </div>
    </div>
