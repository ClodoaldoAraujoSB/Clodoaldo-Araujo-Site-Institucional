  ...
  <body>
    ...
    <div class="lista_empresas">
      ...
      <div class="div_lista_empresas">
        ...
        <button type="button" class="btn btn-dark" data-bs-toggle="modal" data-bs-target="#super_businessModal"><img src="../img/logo-super_business.png" alt="Super Business" style="height: 70px;"></button>
      </div>
    </div>
